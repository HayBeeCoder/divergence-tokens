...
# "${ROOT}/hop6_noprompt/seed-${SEED}/filtered_dataset_dpoints_only.jsonl"
# "${ROOT}/hop7_noprompt/seed-${SEED}/filtered_dataset_dpoints_only.jsonl"
# "${ROOT}/hop8_noprompt/seed-${SEED}/filtered_dataset_dpoints_only.jsonl"
# "${ROOT}/hop9_noprompt/seed-${SEED}/filtered_dataset_dpoints_only.jsonl"
"${ROOT}/hop10_noprompt/seed-${SEED}/filtered_dataset_dpoints_only.jsonl"
"${ROOT}/hop11_noprompt/seed-${SEED}/filtered_dataset_dpoints_only"
)
